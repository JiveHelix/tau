    ...
    double)
{
    ...
    Point2d<TestType> value2d(uniformRandom(), uniformRandom());
    ...
    double)
{
    ...
    if constexpr (std::is_integral_v<TestType>)
    {
        ...
        if constexpr (std::is_signed_v<TestType>)
        {
            ...
            right2d = Point2d<TestType>(uniformRandom(), uniformRandom());
        }
        else
        {
    ...
    double)
{
    ...
    if constexpr (std::is_integral_v<TestType>)
    {
        ...
        if constexpr (std::is_signed_v<TestType>)
        {
            ...
            left3d = Point3d<TestType>(
                uniformRandom(),
                uniformRandom(),
                uniformRandom());

            right3d = Point3d<TestType>(
                uniformRandom(),
                uniformRandom(),
                uniformRandom());
        }
